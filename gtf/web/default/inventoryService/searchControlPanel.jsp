...
<HTML>
  <HEAD>
    <title>Inventory Service::SearchControl Panel</title>
  ...
  <BODY bgcolor="#eaeaea" 
        ...
        marginwidth="5" 
        marginheight="5">
    <wf:WebControl beanID             = "searchControl"
                   controlBuilderName = "org.yang.customized.gtf.services.inventoryManager.web.StorageSearchControlBuilder" />
  </BODY>
</HTML>