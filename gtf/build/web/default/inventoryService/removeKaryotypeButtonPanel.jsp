...
<head>
<title>Remove Karyotype Button Panel</title>
...
<body>
<form id="removeKaryotypeForm" name="removeKaryotypeForm" method="post" action="/wf/karyotypeMasterTable.wf" target="rightFrame2">
              ...
              <table width="100%" border="0"  bgcolor="#FFFFFF">
                <tr>
                  <td align="center" bgcolor="#FFFFFF">
                     ...
                     <label>
          <a href="javascript:confirmDel('removeKaryotypeForm','deleteKaryotypes',1)"
