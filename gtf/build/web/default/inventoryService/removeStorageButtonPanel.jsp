...
<head>
<title>Remove Storage Button Panel</title>
...
<body>
<form id="removeStorageForm" name="removeStorageForm" method="post" action="/wf/storages.wf" target="rightFrame2">
 <input type="hidden" name="actiontype" value="" ID="Hidden1">
  <table border="0" align="center" cellpadding="0">
   ...
   <tr width="100%">
      <td colspan="6" bgcolor="#1D459D" align="right">
              ...
              <table width="100%" border="0"  bgcolor="#FFFFFF">
                <tr>
                  <td align="center" bgcolor="#FFFFFF">
                     ...
                     <label>
          <a href="javascript:confirmDel('removeStorageForm','deleteStorages',1)"
