...
public class InventoryTreeBuilder implements WebControlBuilder
{
   ...
   private GenericPanel createPanel(InventoryTreeBean inventoryTreeBean, String appBase, String codeBase)
   {
      ...
      panel.setText("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='/wf/default/images/serv_section.gif' height='20' width='20'></img><a class='converter' href=\"JavaScript:openWindow('/RNAConverter/index.jsp') \" title='Go to utility tool: Sequence Converter.'> Go to Sequence Converter</a>");
