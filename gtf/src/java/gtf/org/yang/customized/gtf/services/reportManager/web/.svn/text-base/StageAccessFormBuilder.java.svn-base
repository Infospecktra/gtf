...
public class StageAccessFormBuilder implements WebControlBuilder
{
   ...
   {
      ReportsStageAccessBean stageBean = (ReportsStageAccessBean)bean;
      ...
      allowUpdate = stageBean.gotPermit("ReportManager", stageBean.getProjectType(), "update");
      return createPanel(stageBean, appBase, codeBase);
   }

   private GenericPanel createPanel(ReportsStageAccessBean stageBean, String appBase, String codeBase) throws Exception
   {
      ...
      if(stageBean.gotPermit("ReportManager", stageBean.getProjectType(), "xuser"))
      {
      ...
      panel.setActionLink(appBase + "/satgeAccess.wf");
   ...
   private InformationForm createForm(ReportsStageAccessBean stageBean, String codeBase, String dataOwnerName) throws Exception
   {
      isClient = stageBean.gotPermit("ReportManager", stageBean.getProjectType(), ProjectManager.CLIENT);
...
//System.out.println("---------------> stage owner type:" + stageOwnerType);
      ...
      form.setActionLink(stageBean.getAppBase() + "/stageAccess.wf");
      form.setId("stageAccess");

      if(allowUpdate)
      {
         ButtonElement save = new ButtonElement();
         save.setAction("javascript:submitForm('stageAccess','update')");
