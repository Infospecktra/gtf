...
<head>
<title>Remove Button Panel</title>
...
<body>
<form id="removeForm" name="removeForm" method="post" action="/wf/inventory.wf" target="rightFrame2">
              ...
              <table width="100%" border="0"  bgcolor="#FFFFFF">
                <tr>
                  <td align="center" bgcolor="#FFFFFF">
                     ...
                     <label>
          <a href="javascript:confirmDel('removeForm','deleteRecords',1)"
