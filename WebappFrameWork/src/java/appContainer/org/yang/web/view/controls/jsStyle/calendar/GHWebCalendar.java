 ...
 */
abstract public class GHWebCalendar extends WebCalendar
{
   ...
   public GHWebCalendar()
   {
      super();
   }

   public static GHWebCalendar create(int type)
   {
      switch(type)
      {
         case 0: return new GHWebCalendarYearly();
         case 1: return new GHWebCalendarMonthly();
         case 2: return new GHWebCalendarDaily();
      }
      return null;
   }
   ...
   public void render(JspWriter writer) throws Exception
   {
      ...
      writer.println( "			bordercolordark=\"#ffffff\" bgcolor=\"#003399\" align=\"right\">");
      writer.println( "         <tr>");
      writer.println( "            <td align=\"right\" class=\"smallest\"  bgcolor=\"#747880\">");
