...
public class SelectableItemWithoutForm extends SelectableItem
{
   ...
   public boolean isWithoutForm = false;
   public boolean getIsWithoutForm(){return isWithoutForm;}
   public void setIsWithoutForm(boolean isWithoutForm){this.isWithoutForm=isWithoutForm;} 
   
   public SelectableItemWithoutForm()
   {
      super();
   }
   ...
   {  
      ...
      if(null!=caption&&!isCaptionOnTop)
         writer.print("      <b><font color=\"#C0C0C0\">" + caption + " :</font></b>");
