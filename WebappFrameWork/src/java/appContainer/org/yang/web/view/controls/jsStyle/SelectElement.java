...
public class SelectElement extends FormElement 
{
   ...
   private String[] optionStyles = null;
   public void setOptionStyles(String[] optionStyles){this.optionStyles=optionStyles;}
   public String[] getOptionStyles(){return optionStyles;}
   ...
   public void printBody(JspWriter writer) throws Exception
   {
      ...
      for(int i=0; i<values.length; i++)
      {
         ...
         if(optionStyles!=null)
         {
            options[i].setOptionStyle(optionStyles[i]);	
         }    
      ...
      if(null==selectedOption)
      {
         ...
         //writer.print("      <option value=\"" + selectedValue + "\"  class=\""+optionStyle+ "\"   selected>" + selectedValue + "</option>");
      }
