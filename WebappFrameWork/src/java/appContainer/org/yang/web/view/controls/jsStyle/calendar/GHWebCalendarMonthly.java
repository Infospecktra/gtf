 ...
 */
public class GHWebCalendarMonthly extends GHWebCalendar
{
   private static final String[] MONTHS = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                            "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
   public GHWebCalendarMonthly()
   {
      super();
      type = 1;
   }
   ...
   public void printBody(JspWriter writer) throws Exception
   {
      ...
      writer.println( "					<TABLE BORDER=\"0\" CELLSPACING=\"1\" CELLPADDING=\"1\" BGCOLOR=\""+bgcolor+"\">");
      writer.println( "						<TR>");
      ...
      writer.println( "									<TR>");
      writer.println( "										<TD VALIGN=\"bottom\" ALIGN=\"left\" BGCOLOR=\""+bgcolor+"\"><a href=\"" + backwardActionLink + "\"><font face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#ffffff\" size=\"2\">&lt;&lt;</font></a></TD>");
      ...
      writer.println( "										<TD VALIGN=\"bottom\" ALIGN=\"center\" BGCOLOR=\""+bgcolor+"\"><font face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#ffffff\" size=\"2\">" + DateFormatter.getDateTimeString(displayedDate, "yyyy") + "</font></TD>");
      writer.println( "										<TD VALIGN=\"bottom\" ALIGN=\"right\" BGCOLOR=\""+bgcolor+"\"><a href=\"" + forwardActionLink + "\"><font face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#ffffff\" size=\"2\">&gt;&gt;</font></a></TD>");
      writer.println( "									</TR>");
      writer.println( "								</TABLE>");
      writer.println( "							</TD>");
      writer.println( "						</TR>");
      writer.println( "						<TR>");
      writer.println( "							<TD VALIGN=\"bottom\" ALIGN=\"center\" BGCOLOR=\""+bgcolor+"\"><TABLE WIDTH=\"160\" BORDER=\"0\" CELLSPACING=\"1\" CELLPADDING=\"0\">");
